...
const Home: React.FC = () => {
  return (
    <div className=" font-sapce-grotesk">
      <section className="section1 border border-black flex  justify-between gap-x-20 my-10  ">
      ...
      <section className="section2 border border-black flex justify-between flex-wrap my-10">
