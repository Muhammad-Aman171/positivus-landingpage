...
const Home: React.FC = () => {
  return (
    <div className="home-page font-sapce-grotesk">

      
      <section className="section1  flex  justify-between gap-x-20 my-10  ">
        <div className="section1-card w-1/2 flex flex-col justify-around items-start ">
          ...
          <Image
            ...
            className="section1-card-img w-full h-full lg:hidden"
          />
          ...
          <button className="bg-black text-white h-16 w-48 rounded-xl">
            Book a consultation
          </button>
        </div>
        <div className="section1-img w-1/2 max-lg:hidden  ">
          <Image src={Img1} alt="img does not show" className="w-full h-full" />
        </div>
      </section>

      <section className="section2 flex justify-between flex-wrap my-10 max-sm:grid max-sm:grid-cols-2">
      ...
      <section className="section3">
        <div className="section3-heading ">
          ...
          <p>
            ...
            <br className=" "/> help businesses grow and succeed online. These services
            include:
          </p>
        </div>
